...
- Hardened progression save loading so a corrupt primary JSON can still fall back to the backup JSON, clamped corrupted stage progression bounds during save sanitization, then added a Unity-free save safety audit to the static audit chain.
