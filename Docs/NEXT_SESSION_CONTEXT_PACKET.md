...
- Route Payoff B–I named VFX now also have inspectable drafts at `Assets/Art/VFX/Route/` plus Resources copies. Runtime `RoutePayoffVfxDrafts` loads those drafts onto the existing cluster / smash / HOLD / OPEN / residual / chase / warning / bonus slots. Combo/Overdrive pulses and HUD/lobby residual pulses were not drafted.
