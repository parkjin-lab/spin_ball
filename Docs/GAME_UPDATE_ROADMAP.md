...
- `Tools/AuditProgressionSaveSafetyStatic.ps1` now checks the JSON save/backup/default/migration contract so long-term progression cannot silently lose backup fallback or legacy PlayerPrefs migration coverage.
