...
- `Tools/GeneratePlaytestTelemetrySummary.ps1` can convert the telemetry log into a markdown report with both sweep-level and per-run summaries for faster Stage 1-7 review.
...
- `Tools/GeneratePlaytestTelemetrySummary.ps1` produces a readable sweep summary and per-run breakdown after the sweep
