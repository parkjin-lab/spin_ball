...
- `Tools/GeneratePlaytestTelemetrySummary.ps1` can convert the telemetry log into a per-run markdown summary for faster Stage 1-7 review.
...
- `Tools/GeneratePlaytestTelemetrySummary.ps1` produces a readable per-run summary after the sweep
