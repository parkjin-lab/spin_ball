...
$audits = @(
    ...
    [pscustomobject]@{
        Label = "Playtest readiness prep regression"
        ScriptPath = Join-Path $PSScriptRoot "TestPlaytestReadinessPrep.ps1"
        ReportPath = Join-Path $ReportDirectory "AlienCrusherPlaytestReadinessPrepRegression.log"
    },
    [pscustomobject]@{
    ...
    [pscustomobject]@{
        Label = "Resource slot docs"
        ScriptPath = Join-Path $PSScriptRoot "AuditResourceSlotDocsStatic.ps1"
        ReportPath = Join-Path $ReportDirectory "AlienCrusherResourceSlotDocsStaticAudit.log"
    },
    [pscustomobject]@{
        Label = "Progression save safety"
        ScriptPath = Join-Path $PSScriptRoot "AuditProgressionSaveSafetyStatic.ps1"
