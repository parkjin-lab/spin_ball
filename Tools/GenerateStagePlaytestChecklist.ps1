...
$lines.Add('- Playtest summary command: `powershell -ExecutionPolicy Bypass -File Tools/GeneratePlaytestTelemetrySummary.ps1` (includes current tuning snapshot, sweep, stage trend, tuning candidate, and failure bucket summaries when `F10` is used)')
$lines.Add("")
