...
$lines.Add('- Playtest summary command: `powershell -ExecutionPolicy Bypass -File Tools/GeneratePlaytestTelemetrySummary.ps1` (includes sweep, stage trend, and failure bucket summaries when `F10` is used)')
$lines.Add("")
