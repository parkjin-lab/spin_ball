...
$lines.Add('- `F10`: sweep Stage 1 through the debug max stage')
...
$lines.Add('- Playtest summary command: `powershell -ExecutionPolicy Bypass -File Tools/GeneratePlaytestTelemetrySummary.ps1`')
$lines.Add("")
