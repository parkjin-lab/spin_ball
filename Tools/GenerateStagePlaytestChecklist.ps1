...
$lines.Add('- Playtest summary command: `powershell -ExecutionPolicy Bypass -File Tools/GeneratePlaytestTelemetrySummary.ps1` (includes sweep summary when `F10` is used)')
$lines.Add("")
