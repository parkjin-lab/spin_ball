...
if ($errors.Count -eq 0) {
    ...
    elseif (-not (Test-Path -Path $tempAudioChecklistPath -PathType Leaf)) {
        ...
        Add-Check -Errors $errors -ReportText $audioChecklistText -Needle "D. Failure beat visuals" -Label "Audio checklist"
        Add-Check -Errors $errors -ReportText $audioChecklistText -Needle 'VFX_Failure_Ordinary' -Label "Audio checklist"
        Add-Check -Errors $errors -ReportText $audioChecklistText -Needle 'VFX_Failure_Boss' -Label "Audio checklist"
    ...
    elseif (-not (Test-Path -Path $tempStreetPropChecklistPath -PathType Leaf)) {
        ...
        Add-Check -Errors $errors -ReportText $streetPropChecklistText -Needle "## Next Street Prop Batch Task Card" -Label "Street prop checklist"
        Add-Check -Errors $errors -ReportText $streetPropChecklistText -Needle "Gameplay uses: PROP_Car_Compact_A: moving panic target" -Label "Street prop checklist"
        Add-Check -Errors $errors -ReportText $streetPropChecklistText -Needle "Done means: compact car A/B and van/bus have draft silhouettes" -Label "Street prop checklist"
    ...
    elseif (-not (Test-Path -Path $tempUiIconChecklistPath -PathType Leaf)) {
        ...
        Add-Check -Errors $errors -ReportText $uiIconChecklistText -Needle "E. Failure bucket badges" -Label "UI icon checklist"
        Add-Check -Errors $errors -ReportText $uiIconChecklistText -Needle 'Badge_Fail_Opening' -Label "UI icon checklist"
        Add-Check -Errors $errors -ReportText $uiIconChecklistText -Needle 'Badge_Fail_Boss' -Label "UI icon checklist"
    ...
    elseif (-not (Test-Path -Path $tempBossIdentityChecklistPath -PathType Leaf)) {
        ...
        Add-Check -Errors $errors -ReportText $bossIdentityChecklistText -Needle 'Icon_Boss_Sentinel' -Label "Boss identity checklist"
        Add-Check -Errors $errors -ReportText $bossIdentityChecklistText -Needle "E. Lobby/result Sentinel icon" -Label "Boss identity checklist"
    }
    ...
    elseif (-not (Test-Path -Path $tempOutgameProgressionChecklistPath -PathType Leaf)) {
        ...
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "F. Next-run spend change pulse" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "G. Stage select confirm pulse" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "H. Meta purchase confirm pulse" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "I. DP gain residual afterglow" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "J. Result next-action ready pulse" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "K. Stage unlock banner pulse" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "L. Form unlock confirm pulse" -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle "M. Result next-action residual afterglow" -Label "Outgame progression checklist"
        ...
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_SpendChange_Ready' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_StageSelect_Confirm' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_MetaUpgrade_Confirm' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_DP_Gain_Residual' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_NextAction_Ready' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_StageUnlock_Ready' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_FormUnlock_Confirm' -Label "Outgame progression checklist"
        Add-Check -Errors $errors -ReportText $outgameProgressionChecklistText -Needle 'VFX_NextAction_Residual' -Label "Outgame progression checklist"
    ...
    elseif (-not (Test-Path -Path $tempRoutePayoffChecklistPath -PathType Leaf)) {
        ...
        Add-Check -Errors $errors -ReportText $routePayoffChecklistText -Needle 'VFX_RouteOpen_Trail' -Label "Route payoff checklist"
        Add-Check -Errors $errors -ReportText $routePayoffChecklistText -Needle "E. ROUTE OPEN trail pulse" -Label "Route payoff checklist"
        Add-Check -Errors $errors -ReportText $routePayoffChecklistText -Needle 'VFX_LaneBreak_Residual' -Label "Route payoff checklist"
        ...
        Add-Check -Errors $errors -ReportText $routePayoffChecklistText -Needle 'VFX_RouteBonus_Success' -Label "Route payoff checklist"
        Add-Check -Errors $errors -ReportText $routePayoffChecklistText -Needle "I. ROUTE BONUS success pulse" -Label "Route payoff checklist"
    }
}
