...
Invoke-GeneratorCheck `
    ...
    -Needles @("## Current Blocking State", "Resource production batch focus:", "Recommended production batch order:", "## Safe Autonomous Work Queue", "## Next Resource Batch Task Card", "Source: Audio", "Batch: A. Route and failure rhythm", "## Next Resource Batch Briefs", "short upward cue that says the lane just opened", "five distinct rhythm punctuation marks", "## Recommended Production Batch Order", "## Production Batch Focus", "Prefer complete production batches", "Result: autonomous work backlog generated") `
