...
Invoke-GeneratorCheck `
    ...
    -Needles @("## Current Blocking State", "Resource production batch focus:", "## Safe Autonomous Work Queue", "## Production Batch Focus", "Prefer complete production batches", "Result: autonomous work backlog generated") `
