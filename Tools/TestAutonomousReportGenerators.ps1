...
Invoke-GeneratorCheck `
    ...
    -Needles @("## Current Blocking State", "## Safe Autonomous Work Queue", "Result: autonomous work backlog generated") `
...
Invoke-GeneratorCheck `
    ...
    -Needles @("## P0 Backlog", "## Recommended Autonomous Order", "Result: resource production backlog generated") `
    -PowerShellExecutable $powerShellExecutable `
    -Errors $errors
